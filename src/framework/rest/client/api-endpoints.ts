export const API_ENDPOINTS = {
  ...
  TAGS: '/tags',
  SHOPS: '/shops',
  SHOPS_DISCOVERY: '/shops/discovery',
  AUTHORS: '/authors',
  ...
  ORDERS_DELIVERY_PROOF: (id: string | number) => `/orders/${id}/delivery-proof`,
  ORDERS_VALIDATE_CODE: (id: string | number) => `/orders/${id}/validate-code`,
  GENERATE_DOWNLOADABLE_PRODUCT_LINK: '/downloads/digital_file',
  USERS: '/users',
  USERS_ADDRESS: '/address',
  USERS_ME: '/me',
  /** Redeem wallet points for a user-owned coupon (backend contract TBD). */
  USERS_COUPON_FROM_POINTS: '/me/coupons/from-points',
  USERS_LOGIN: '/token',
