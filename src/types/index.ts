...
export interface OrderQueryOptions extends QueryOptions {
  name: string;
  orderBy: string;
  assigned?: boolean; // Filter orders assigned to the current delivery person
}
...
export type RedeemPointsCouponRequest = {
  points: number;
...
export interface Order {
  ...
  delivery_time_estimation?: number;
  delivery_method?: string;
  delivery_person_id?: number | string;
  delivery_proof?: {
    photo_url: string;
    notes: string;
    timestamp: string;
