...
const ProductReviews: React.FC<ProductReviewsProps & { product?: any }> = ({
  productId,
  productType,
  product,
}) => {
  ...
  return (
    <div>
      ...
      >
        <div
          className={cn(
            'flex flex-col justify-between sm:flex-row sm:items-center py-4',
            {
        ...
        >
          <div className="flex items-center space-x-4 rtl:space-x-reverse">
            ...
            <Button
              variant="custom"
              className="!h-8 !px-3 !text-xs bg-accent/10 !text-accent hover:bg-accent hover:!text-white transition-all duration-300 rounded-full font-bold"
